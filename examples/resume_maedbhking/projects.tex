...
%---------------------------------------------------------
  \cventry 
    ...
    {\href{https://psychblog.berkeley.edu/blog/}{\textbf{Blog [Link]}}} % Organization
    {Sep. 2018 - } % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
...
%---------------------------------------------------------
  \cventry
    ...
    {\href{https://www.mttamcollege.org/}{\textbf{Lecturer [Link]}}} % Organization 
  ...
  \cventry
    ...
    {\href{https://jeps.efpsa.org/articles}{\textbf{Paper [Link]}}} % Position
    {2014 - 2016} % Location
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
