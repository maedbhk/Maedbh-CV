...
%---------------------------------------------------------
  \cventry
    {Sep. 2022 - } % Date(s)
    {Undergraduate Research Assistants at MIT} % Student
    {\textbf{Alyson Brown, Shreya Ravikumar}} 
    {Psychology; Computer Science} % Position
    {
...
%---------------------------------------------------------
  \cventry
    ...
    {Honors Thesis Students at Berkeley} % Student
...
%---------------------------------------------------------
  \cventry
    ...
    {Undergraduate Research Assistants at Berkeley} % Student
...
%---------------------------------------------------------
  \cventry
    ...
    {Ph.D. Rotation Students at Berkeley} % Student
...
%---------------------------------------------------------
  \cventry
    {Sep. - Dec. 2018} % Date(s)
    {Post-Baccalaureate Students at Berkeley} % Student
    {\textbf{Dylan Benkley}}
    {Psychology}
   {
      \begin{cvitems} % Description(s) of tasks/responsibilities
