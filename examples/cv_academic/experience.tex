...
%---------------------------------------------------------
  \cventry
    {\href{https://yangtan.mit.edu/icon/icon-center-researchers/}{McGovern Institute at MIT [Link]}} % Job title
    {ICoN Postdoctoral Fellow (2022-)}
    {MIT}
    {} % Organization
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Building computational models that integrate biological and behavioral information to develop risk predictors of neuropsychiatric disorders.} 
      \end{cvitems}
    }
